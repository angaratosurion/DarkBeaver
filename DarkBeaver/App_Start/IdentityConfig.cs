...
namespace DarkBeaver
{
    ...
    public class ApplicationUserManager : BlackCogs.Application.ApplicationUserManager
    {
    ...
    public class ApplicationSignInManager : BlackCogs.Application.ApplicationSignInManager
    {
